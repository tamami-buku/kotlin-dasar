...
Pada kode di atas, baris ke-2 bermaksud membuat iterasi dari angka \texttt{1} sampai dengan angka \texttt{5} yang nilainya disimpan dalam variabel \texttt{i}.
